...
public final class SecAccessControl {
	...
	private final SecRandomRef random;

	private final int cost;

	public SecAccessControl() {
		this(DEFAULT_COST);
	}
	 ...
	 *            to 30
	 */
	private SecAccessControl(int cost) {
		iterations(cost); /* Validate cost */
		this.cost = cost;
		this.random = new SecRandomRef();
	}
